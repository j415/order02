		...
		<div class="am-container header">
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form>
						<input id="searchInput" name="index_none_header_sysc" type="text" placeholder="松子" autocomplete="off">
						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">														
							<div class="searchAbout">
								...
								<a title="瓜子" href="#">葡萄干</a>
								<a title="鸡腿" href="#">柠檬</a>

							</div>
							<ul class="select">
								<p class="title font-normal">
									<span class="fl">松子</span>
									<span class="total fl">搜索到<strong class="num">999</strong>件相关商品</span>
								</p>
								<div class="clear"></div>
								...
								<%  ProductDaoImp dao=new ProductDaoImp();
									...
									<li>
										<div class="i-pic limit">
											...
											<a href="detail.jsp?id=<%=p.getId()%>"><img src="images/small-<%=p.getImg()%>" /></a>
